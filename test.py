...
WIDTH, HEIGHT = 600, 640  # Aumentamos a altura para incluir o cabeçalho
CELL_SIZE = 20  # Tamanho de cada célula do tabuleiro
ROWS, COLS = (HEIGHT - 40) // CELL_SIZE, WIDTH // CELL_SIZE  # Ajuste para o cabeçalho
...
def draw_header(found_words):
    header_text = f"Palavras encontradas: {found_words}/{len(WORDS)}"
